...
const account_changes =
  "CREATE TABLE IF NOT EXISTS account_changes(change_number INT PRIMARY KEY,account_number INT,amount NUMERIC(10,2) , changed_date DATETIME, remark TEXT,FOREIGN KEY(account_number) REFERENCES account(account_number)) ";
